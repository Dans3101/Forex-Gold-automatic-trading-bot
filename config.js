...
export const phoneNumber = process.env.WHATSAPP_PHONE || ""; // WhatsApp number in international format
export const groupId = process.env.WHATSAPP_GROUP || "";     // WhatsApp Group ID
...
//  Bot Signal Settings (convert to numbers with defaults)
